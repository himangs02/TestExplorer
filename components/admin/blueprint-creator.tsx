                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        required 
                        disabled={loading}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-black outline-none disabled:bg-gray-50 disabled:text-gray-400" 
                      />
                    </div>
                          ...
                          <div key={sub.id} className="flex items-center justify-between bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <input 
                                ...
                                min="0"
                                disabled={loading}
                                className="w-20 px-2 py-1.5 rounded-lg border border-gray-300 text-center font-bold focus:ring-2 focus:ring-black outline-none disabled:bg-gray-100"
                              />
                            </div>
                          </div>
                        ))}
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span>{isEditMode ? 'Update & Auto-Generate' : 'Save & Auto-Generate'}</span>
                      </>
                    )}
                  </button>
                </div>
