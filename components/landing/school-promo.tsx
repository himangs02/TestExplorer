      ...
      <div className="max-w-3xl sm:max-w-4xl mx-auto relative group">
        ...
        <div className="relative bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 md:p-9 shadow-xl flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 overflow-hidden">
          ...
          <div className="flex-1 space-y-3.5 sm:space-y-4 text-center lg:text-left z-10">
            ...
            <p className="text-gray-500 text-xs sm:text-sm font-medium max-w-md mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 text-xs font-bold text-gray-600">
          ...
          <div className="shrink-0 bg-slate-50 p-5 sm:p-6 rounded-2xl border border-slate-100 text-center min-w-[220px] sm:min-w-[240px] relative shadow-xs">
            ...
            <div className="space-y-1 mt-2">
              <div className="relative inline-block">
                ...
                <span className="text-xl sm:text-2xl font-black text-gray-400 opacity-50 tracking-tight">
                  ₹1000
                </span>
                {/* THE RED BOLD LINE */}
              ...
              <div className="flex flex-col items-center">
                <span className="text-4xl sm:text-5xl font-black text-blue-600 tracking-tight drop-shadow-xs">
                  FREE
                </span>
            ...
            <Link
              href="/exams/cuet"
              className="block mt-5 w-full bg-gray-900 hover:bg-blue-600 text-white font-bold py-2.5 sm:py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-blue-200 flex items-center justify-center gap-2 group active:scale-95 text-center text-xs sm:text-sm"
            >
              Get Started Now
