...
// Animation style for the vertical scroll
const scrollAnimationStyles = {
  animation: "scroll-vertical 20s linear infinite",
};

export default async function SchoolUpdates({ school }: { school: any }) {
  // Fetch Announcements for this specific school
  ...
  return (
    <div className="bg-gray-50 pb-20">
      <section className="relative w-full py-20 overflow-hidden">
        ...
        {/* === 1. PRINCIPAL'S DESK / MESSAGE SECTION === */}
        ...
        {/* === 2. SCHOOL PARTNERSHIP / PROMO SECTION === */}
